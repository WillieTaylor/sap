...
float triprod  ( Vec, Vec, Vec );
float trinorm  ( Vec, Vec, Vec );
...
float torsion ( Seg, Seg );
// returns the torsion angle down b-c given a,b,c,d

float dihedral (Vec, Vec, Vec, Vec );
// returns the dihedral angle (torsion down contact normal)

float dihedral ( Seg, Seg );
// returns the dihedral angle (torsion down contact normal)
...
float   lineOline ( Seg, Seg, Vec* );
float   lineOline ( Vec, Vec, Vec, Vec, Vec* );
int     dot2pair ( Vec, Vec, Vec, Vec*, Vec* );
float   recp_area ( Vec*, float, float );
float   recp_area ( Seg, Seg, float, float );
