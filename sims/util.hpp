...
#define Patom(n,v) printf("ATOM%7d  CA  GLY A%4d     %7.3f %7.3f %7.3f  1.00  0.00\n", n,n,v.x,v.y,v.z);
#define Patid(n,a,v) printf("ATOM%7d  C%c  GLY A%4d     %7.3f %7.3f %7.3f  1.00  0.00\n", n,'A'+a,n,v.x,v.y,v.z);
#define NL	cout<<"\n";
#define PT	cout<<"\t";
#define SP	cout<<" ";
#define SPP	cout<<"  ";
...
int sort3min ( float, float, float );
int sort3max ( float, float, float );
int sort3min ( int, int, int );
int sort3max ( int, int, int );
...
float marryup ( float**, int, int, Pairs*, int* );

// max score match (heuristic)
float pairup ( float**, int, Pairs* );
